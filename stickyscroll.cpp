#include "stickyscrollconstants.h"
#include "stickyscrolltr.h"
...
namespace StickyScroll::Internal {
...
public:
    StickyScrollPlugin() = default;

    ~StickyScrollPlugin() final
    {
    ...
    void initialize() final
    {
        ...
        menu->menu()->setTitle(Tr::tr("StickyScroll"));
        ActionManager::actionContainer(Core::Constants::M_TOOLS)->addMenu(menu);

        ActionBuilder(this, Constants::ACTION_ID)
            .addToContainer(Constants::MENU_ID)
            .setText(Tr::tr("StickyScroll Action"))
            .setDefaultKeySequence(Tr::tr("Ctrl+Alt+Meta+A"))
            .addOnTriggered(this, &StickyScrollPlugin::triggerAction);
    }
...
private:
    void triggerAction()
    {
        QMessageBox::information(ICore::dialogParent(),
                                 ...
                                 Tr::tr("This is an action from StickyScroll."));
    }
};
